...
\subsubsection*{Strong Sector: Color and Confinement as Open Problems}
\label{subsec:qcd-topology}

The origin of color charge, confinement, and asymptotic freedom within
the projection framework is an open problem.
The framework does not currently derive a topological invariant
identifying composite sectors, a confinement mechanism, or a
short-distance weakening of the effective interaction.
